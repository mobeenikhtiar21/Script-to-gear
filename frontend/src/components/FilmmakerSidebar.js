...
import { LayoutDashboard, Sparkles, FolderOpen, LogOut, FileText, User } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function FilmmakerSidebar({ user, onLogout }) {
  ...
  const navItems = [
    ...
    },
    {
      label: 'New Analysis',
      icon: Sparkles,
      path: '/filmmaker/create-project',
      testId: 'nav-new-analysis'
    },
    {
  ...
  return (
    <div className="w-64 h-screen bg-[#050505] border-r border-[#2A2A2A] flex flex-col fixed left-0 top-0" data-testid="filmmaker-sidebar">
      {/* Logo Section */}
      <div className="p-4 border-b border-[#2A2A2A]">
        ...
        >
          ...
          <div className="text-left">
            ...
            <div className="text-[#666666] text-xs font-mono">Filmmaker</div>
          </div>
        </button>
      </div>
