...
export default function FilmmakerSidebar({ user, onLogout }) {
  ...
  return (
    <div className="w-64 h-screen bg-[#0F0F0F] border-r border-[#2A2A2A] flex flex-col fixed left-0 top-0" data-testid="filmmaker-sidebar">
      {/* Logo Section */}
      <div className="p-6 border-b border-[#2A2A2A]">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[#666666] text-xs">Filmmaker Portal</div>
          </div>
        </div>
      </div>
